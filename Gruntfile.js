// Generated on 2014-08-11 using generator-angular 0.9.0-1
'use strict';
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      styles: {
        ...
        tasks: ['concat:css', 'newer:copy:styles', 'autoprefixer']
      },
      gruntfile: {
        files: ['Gruntfile.js']
      },
